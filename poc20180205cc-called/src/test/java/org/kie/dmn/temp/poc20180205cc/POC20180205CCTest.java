...
package org.kie.dmn.temp.poc20180205cc;
...
public class POC20180205CCTest {

    static final Logger LOG = LoggerFactory.getLogger(POC20180205CCTest.class);
    ...
    public static void init() {
        ...
        dmnRuntime = kContainer.newKieSession("KSessionCalled").getKieRuntime(DMNRuntime.class);
